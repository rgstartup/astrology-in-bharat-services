...
async function fixUser() {
    const client = new Client({
        connectionString: 'postgresql://neondb_owner:npg_r94TzaWBnjVv@ep-wispy-sky-a1j6w3i2-pooler.ap-southeast-1.aws.neon.tech/aibdb?sslmode=require&channel_binding=require'
    });
