...
import { Coupon, CouponStatus } from '@/modules/coupon/infrastructure/persistence/entities/coupon.entity';
import { UserCoupon } from '@/modules/coupon/infrastructure/persistence/entities/user-coupon.entity';
