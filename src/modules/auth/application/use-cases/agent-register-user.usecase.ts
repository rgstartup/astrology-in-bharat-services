...
export class AgentRegisterUserUseCase {
    ...
    async execute(dto: AgentRegisterUserDto, agentId: number) {
                ...
                createdUser = await this.usersFacade.create(
                    {
                        ...
                        email_verified_at: isMerchant ? new Date() : undefined,
                    },
                    queryRunner,
                );
        ...
        if (isMerchant) {
            emailSubject = 'Merchant Account Created - Puja Shop Dashboard';
            emailContent = `
                <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eee; border-radius: 10px;">
                    ...
                    <p>Use the following credentials to log in to your merchant dashboard:</p>
                    ...
                    <p>You can access your dashboard here: <a href="${this.configService.get('email.merchantFrontendUrl') || process.env.MERCHANT_FRONTEND_URL || '#'}" style="color: #673ab7; font-weight: bold;">Merchant Dashboard</a></p>
