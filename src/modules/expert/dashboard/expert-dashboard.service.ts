...
import { Transaction, TransactionType, TransactionPurpose } from '@/modules/wallet/entities/transaction.entity';
...
export class ExpertDashboardService {
    constructor(
        ...
        private expertProfileRepo: Repository<ProfileExpert>,
    ) { }
