...
export class LoveCalculatorService {
    calculateLove(yourName: string, partnerName: string, yourGender?: string, partnerGender?: string) {
        ...
        if (score >= 90) {
            ...
            message = 'Nice Connection! Intezaar kijiye, pyaar dheere dheere badhega.';
        }
