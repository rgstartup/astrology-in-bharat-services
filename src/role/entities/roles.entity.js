...
var Role = function () {
    ...
    var Role = _classThis = /** @class */ (function () {
        function Role_1() {
            ...
            this.name = (__runInitializers(this, _id_extraInitializers), __runInitializers(this, _name_initializers, void 0)); // e.g. "admin", "client", "expert"
    ...
    (function () {
        ...
        _users_decorators = [(0, typeorm_1.ManyToMany)(function () { return user_entity_1.User; }, function (u) { return u.roles; })];
